...
public class PaiceHuskStemmer {
    ...
    /**
     * Read rules in from fr and enters them into ruleTable, ruleIndex is set up to
    ...
    /**
     * Checks lower-case word for position of the first vowel
     * @param word
     * @param last
     * @return
     */
    ...
    /**
     * Determine whether 'ch' is a vowel or not * uses 'prev' determination when ch == y
     * @param ch
     * @param prev
     * @return boolean
     */
    ...
    /**
     * Remove all non letter or digit characters from srt and return
     * @param str
     * @return
     */
